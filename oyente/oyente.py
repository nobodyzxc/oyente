...
def main():
    ...
    parser.add_argument( "-cfg-weak", "--cfg-weak",   help="Generate control flow graph marked with weak paths", dest="cfg_weak", action="store_true")
    parser.add_argument( "-cfg-gas", "--cfg-gas",   help="Generate control flow graph marked with max gas cost path", dest="cfg_gas", action="store_true")
